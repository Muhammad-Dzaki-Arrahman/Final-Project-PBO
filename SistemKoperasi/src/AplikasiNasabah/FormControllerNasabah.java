...
public class FormControllerNasabah implements Initializable {
    DataModelNasabah ndm;
    ...
    void handleHapusIndiBtn(ActionEvent event) {
        try {
            ...
            Logger.getLogger(FormControllerNasabah.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ndm = new DataModelNasabah("MYSQL");
