...
public class DataModelNasabah {
    public final Connection conn;
    
    public DataModelNasabah(String driver) throws SQLException {
    ...
    public ObservableList<Individu> getIndividu(){
        ...
        try {
            ...
            Logger.getLogger(DataModelNasabah.class.getName()).log(Level.SEVERE, null, ex);
        }     
        return data;
    }
